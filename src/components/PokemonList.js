...
export const PokemonList = () => {
  const { getAllPokemon, pokemonList, selectedPoke } = useContext(
    GlobalContext
  );
      ...
      <>
        <div className="custom-container">
          <div className="button-group pull-left">
            <button
              className={`btn coreBtn ${gen === "1" ? "selected" : ""}`}
              value="1"
              onClick={onClick}
            >
            ...
            <button
              className={`btn coreBtn ${gen === "2" ? "selected" : ""}`}
              value="2"
              onClick={onClick}
            >
            ...
            <button
              className={`btn coreBtn ${gen === "3" ? "selected" : ""}`}
              value="3"
              onClick={onClick}
            >
            ...
            <button
              className={`btn coreBtn ${gen === "4" ? "selected" : ""}`}
              value="4"
              onClick={onClick}
            >
            ...
            <button
              className={`btn coreBtn ${gen === "5" ? "selected" : ""}`}
              value="5"
              onClick={onClick}
            >
            ...
            <button
              className={`btn coreBtn ${gen === "6" ? "selected" : ""}`}
              value="6"
              onClick={onClick}
            >
            ...
            <button
              className={`btn coreBtn ${gen === "7" ? "selected" : ""}`}
              value="7"
              onClick={onClick}
            >
            ...
            <button
              className={`btn coreBtn ${gen === "8" ? "selected" : ""}`}
              value="8"
              onClick={onClick}
            >
              <span>Megas</span>
